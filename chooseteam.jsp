	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			...
			<div class="page-header" style= "font-family: 'Montserrat', sans-serif;";>
				<h1 style="color:#00004d"> <p> Choose your team </h1>
			</div>
...
<div class="alert alert-success" role="success" style= "font-family: 'Montserrat', sans-serif;"; <b> <center> <h4 style="color:#00004d"> In order to complete your registration you should choose your team. </h4> </b> </center> </div>
